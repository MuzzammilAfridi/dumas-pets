...
const Hero = () => {
  ...
  const categories = [
    { title: "PET FOOD", image: product1 },
    { title: "TREATS", image: product2 },
    { title: "CAKES", image: product3 },
  ];

  return (
    <section className="bg-primary relative overflow-hidden" style={{ height: "calc(100vh - 4rem)" }}>
