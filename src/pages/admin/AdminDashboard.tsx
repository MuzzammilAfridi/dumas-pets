...
const chartData = [
  { name: 'Mon', orders: 4 }, { name: 'Tue', orders: 7 }, { name: 'Wed', orders: 5 },
  { name: 'Thu', orders: 8 }, { name: 'Fri', orders: 12 }, { name: 'Sat', orders: 9 }, { name: 'Sun', orders: 6 },
];
...
const AdminDashboard = () => {
  ...
  const stats = [
    { label: 'Total Orders', value: mockOrders.length, icon: ShoppingBag, color: 'text-primary' },
    ...
    { label: 'Customers', value: mockCustomers.length, icon: Users, color: 'text-secondary' },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader><CardTitle className="text-lg">Weekly Orders</CardTitle></CardHeader>
          <CardContent>
