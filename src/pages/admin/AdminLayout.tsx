...
import { LayoutDashboard, Package, ShoppingBag, Users, LogOut, Menu, X, ClipboardList, ChefHat, Truck, FileText, Route } from 'lucide-react';
...
const navItems = [
  ...
  { label: 'Delivery Trip', path: '/admin/delivery-trip', icon: Route },
